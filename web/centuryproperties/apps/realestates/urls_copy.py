...
from .views import (
                    ...
                    export_unapproved_payments, get_employee_with_clients_and_payments, download_clients_pdf, activate_obj_function,
                    upload_file, get_data_link, attach_land_to_client, record_payment, add_land, land_list, update_land,
                    delete_land, edit_payment, delete_payment_record, clients_with_lands, land_transaction_history,
                    employee_clients_made_payment, edit_employee_payment, employee_pay_breakdown, client_payment, main, update_client_land, client_land_info,
                    client_payment_info, client_list_api, create_client_land, update_payment, get_payment_records, delete_client_payment_record,
                    employee_list_api, employees_clients, show_content, admin_add_distributor, employees_payslip_by_clients, get_employee_payslip_detail,
                    confirm_employee_payment, edit_employee_payment_detail, delete_employee_payment_record)
...
urlpatterns = [
    ...
    # path('delete-payment-record/<int:pk>/', delete_payment_record, name='delete_payment_record'),

    # ================  new  ================

    path('show_content/', show_content, name='show_content'),
    path('main-overview/', main, name='main'),
    path('update_client_land/<int:client_id>/', update_client_land, name='update_client_land'),
    path('client-land-info/<int:client_id>/', client_land_info, name='client_land_info'),
    path('client-payment-info/<int:client_id>/', client_payment_info, name='client_payment_info'),
    path('client-list-api/', client_list_api, name='client-list-api'),
    path('employee-list-api/', employee_list_api, name='employee-list-api'),
    path('employee-clients/<int:employee_id>/', employees_clients, name='employees_clients'),
    path('create_client_land/<int:client_id>/', create_client_land, name='create_client_land'),
    path('update-payment/<int:payment_id>/', update_payment, name='update_payment'),
    path('get-payment-records/', get_payment_records, name='get_payment_records'),
    path('delete-client-payment-record/<int:pk>/', delete_client_payment_record, name='delete_client_payment_record'),
    path('admin_add_distributor/', admin_add_distributor, name='admin_add_distributor'),
    path('employees-payslip-by-clients/<int:employee_id>/', employees_payslip_by_clients,
         name='employees_payslip_by_clients'),
    path('get-employee-payslip-detail/<int:employee_id>/<int:client_land_id>/',
         get_employee_payslip_detail, name='get_employee_payslip_detail'),
    path('approve-employee-payment/<int:employee_id>/<int:client_id>/<int:client_land_id>/',
         confirm_employee_payment, name='confirm_employee_payment'),
    path('edit-employee-payment-detail/<int:payment_record_id>/<int:employee_id>/<int:client_id>/<int:client_land_id>/',
         edit_employee_payment_detail, name='edit_employee_payment_detail'),
    path('delete-employee-payment-record/<int:payment_record_id>/<int:employee_id>/<int:client_id>/<int:client_land_id>/',
         delete_employee_payment_record,  name='delete_employee_payment_record'),
    ...
    # ========== file upload and database clean up for admin alone ===========
    ...
    path('download/clients/', download_clients_pdf, name='download_clients_pdf'),
